...
class Teacher_model extends CI_Model {
	...
	$this->db->select('teachers.id as teacher_id, teachers.name as teacher_name, teachers.designation, teachers.phone, department.name as department_name, college.name as college_name, district.name as district_name, thana.name as thana_name');
	...
	$this->db->join('district', 'district.id=teachers.district_id', 'left');
        $this->db->join('thana', 'thana.id=teachers.thana_id', 'left');
