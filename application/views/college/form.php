		...
		<div class="form-group">
			...
			<select name="division_id" class="form-group form-control" id="division_id">
			    ...
			    <?php foreach ($division_list as $division) { ?>
    			    ...
    			    <option value="<?php echo $division["id"]; ?>" <?php if ($division["id"] == $division_id) {
				echo 'selected';
			    } ?> >
...
<?php foreach ($district_list as $district) { ?>
    			    ...
    			    <option value="<?php echo $district["id"]; ?>" <?php if ($district["id"] == $district_id) {
				    echo 'selected';
				} ?> >
...
//    print_r($college_category_list);
	    ...
	    ?> >HSC</option>
			...
			foreach ($college_category_list as $value) {
			    if (in_array("Master's Prili", $value))
				echo "selected";
			}
			...
			foreach ($college_category_list as $value) {
			    if (in_array("Master's Final", $value))
				echo "selected";
			}
			?>
