   ...
   <div class="col-md-8">
     <div class="search_bar">
       <div class="form-group">
         ...
         <input type="search" name="search" placeholder="Search By Jonal Name" class="form-control">
   ...
   <div class="col-md-4">
       <div class="form-group">
         ...
         <div class="pull-right"> 
          <a href="<?php echo base_url()?>jonal/add" class="btn btn-info pull-right" > 
   ...
   <div class="col-md-12">
    ...
    <table class="table table-bordered table-hover ">
      ...
      <tr id="action_btn_align">
          ...
          echo highlight_phrase($jonal['jonal_name'], "$search", '<span style="color:#36960E;">', '</span>');
          ?></td>
